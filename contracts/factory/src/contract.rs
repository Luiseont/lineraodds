...
mod tests {
    ...
    use super::{FactoryContract, FactoryState};
    ...
    fn create_and_instantiate_app(initial_value: u64) -> FactoryContract {
        let runtime = ContractRuntime::new().with_application_parameters(());
        let mut contract = FactoryContract {
            state: FactoryState::load(runtime.root_view_storage_context())
                .blocking_wait()
