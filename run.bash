...
linera -w3 wallet init --faucet "$LINERA_FAUCET_URL"
...
export INFO_3=($(linera --with-wallet 3 wallet request-chain --faucet $LINERA_FAUCET_URL))
...
cleanup() {
  ...
  wait "$PID_MAIN" "$PID_W1" "$PID_W2" "$PID_W3" 2>/dev/null || true
