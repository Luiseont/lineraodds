          ...
          <div v-else class="space-y-4">
            ...
            <div class="flex gap-3">
              ...
              <button
                ...
                class="flex-1 px-4 py-3 text-white bg-primary rounded-xl font-bold hover:bg-primary-dark transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-primary/20 flex items-center justify-center gap-2"
              >
