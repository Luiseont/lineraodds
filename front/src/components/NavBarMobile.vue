      ...
      <div class="flex justify-between items-center py-3">
        ...
        <div class="hidden sm:flex items-center gap-2">
          ...
          <div class="ml-2 inline-flex items-center gap-2 px-3 py-1.5 rounded-brand bg-white/10 border border-white/20 text-sm">
            ...
            <span class="font-medium text-white">{{ formattedWalletBalance }} USDL</span>
          </div>
          
          <button @click="showWalletModal = !connected" :disabled="connecting" class="inline-flex items-center gap-2 px-3 py-1.5 rounded-brand border border-white/20 text-sm text-white hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-white/30 disabled:opacity-60">
...
const { formattedWalletBalance } = useApp();
