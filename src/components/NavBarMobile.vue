<template>
  ...
  <div class="hidden sm:flex items-center gap-2">
          ...
          <!-- Connect button: connects only, shows abbreviated address when connected -->
          <button @click="onConnectClick" :disabled="connecting" class="ml-2 inline-flex items-center gap-2 px-3 py-1.5 rounded-brand border border-white/20 text-sm text-white hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-white/30 disabled:opacity-60">
      ...
      <div v-show="open" class="sm:hidden pb-3 space-y-1">
        ...
        <div class="pt-2">
          <div class="flex items-center gap-2">
            <button @click="onConnectClick" :disabled="connecting" class="flex-1 inline-flex items-center justify-center gap-2 px-3 py-2 rounded-brand border border-white/20 text-sm text-white hover:bg-white/10 focus:outline-none focus:ring-2 focus:ring-white/30 disabled:opacity-60">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-4 h-4">
                <path d="M12 1a4 4 0 00-4 4v2H6a3 3 0 00-3 3v7a3 3 0 003 3h12a3 3 0 003-3v-7a3 3 0 00-3-3h-2V5a4 4 0 00-4-4zm-2 6V5a2 2 0 114 0v2h-4z"/>
              </svg>
              <span v-if="connecting" class="animate-pulse">Connecting...</span>
